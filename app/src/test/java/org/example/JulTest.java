...
public class JulTest {
    ...
    /**
     * {@link java.util.logging.LogManager} is a global singleton and responsible for managing configuration, loggers and listeners
     * <p>
     * {@link java.util.logging.LogManager.LoggerContext} is a map for managing loggers
     * <p>
     * {@link java.util.logging.Logger} is responsible for publishing {@link java.util.logging.LogRecord}
     * to {@link java.util.logging.Handler}
     * <p>
     * {@link java.util.logging.Formatter} is responsible for formatting {@link java.util.logging.LogRecord}
     */
    @Test
...
//        System.out.println("handlers2 = " + handlers2);
    ...
    List<Handler> getHandlersHierarchically(Logger logger) {
        ...
        for (; l != null; ) {
            ...
            if (l.getUseParentHandlers()) l = l.getParent();
            else break;
        }
        return list;
    }
